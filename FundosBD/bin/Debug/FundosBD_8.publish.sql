...
:setvar DefaultDataPath "C:\Users\Adriano\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
:setvar DefaultLogPath "C:\Users\Adriano\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
...
CREATE TABLE [dbo].[Fundos] (
    ...
    CONSTRAINT [PK_CodigoDoSistema] PRIMARY KEY CLUSTERED ([CodigoDoSistema] ASC),
...
GO
PRINT N'Creating [dbo].[InstituicoesFinanceiras]...';


GO
CREATE TABLE [dbo].[InstituicoesFinanceiras] (
